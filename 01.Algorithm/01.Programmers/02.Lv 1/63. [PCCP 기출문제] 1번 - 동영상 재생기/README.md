...
**
아 그리고 java.format() 은 부끄럽지만, 처음 사용해본것 같아요.
일의 자리면 0을 붙이고, 아니면 안붙이고 하는건 너무 비효율적이고, 다른 무언가가 있을거야!! 하고 찾아봤는데,
%d, $02d, %s, %f 같은건 C언어에서 배운 문법인것 같아서 너무 반가웠고, Java에서도 가능하다는게 너무 신기했습니다!
``` 